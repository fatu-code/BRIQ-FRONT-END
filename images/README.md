...
brc.jpg           BRC mesh A142
wire.jpg          Binding wire
block-6.jpg       Hollow block 6"
block-9.jpg       Hollow block 9"
sand-river.jpg    River sand
sand-lake.jpg     Plaster sand
ballast.jpg       Aggregate / ballast
hardcore.jpg      Hardcore
sheet-28.jpg      Iron sheets G28
nails.jpg         Nails
```

New SKUs use the same rule: file name = the material's `id` + `.jpg`.
(Also expected here for the PWA install: `icon-192.png`, `icon-512.png`.)
